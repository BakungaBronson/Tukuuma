        ...
        <div class="col-sm-6 justify-content-center align-items-center text-justify p-2">
            <div class="variation p-3">
                <ul>
                    ...
                    <li>To engage over 5,000 youths and children in Uganda in Environment and Climate action projects by 2030.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="us display variation-light border border-white">
    ...
    <div class="row justify-content-center align-items-center mt-3" id="remove_margin5">
        <div class="text-center justify-content-center align-items-center">
            <h3>Contact Us Today</h3>
            <div>
                <p><i class='bx bx-phone' style='color:#0a5b7c' ></i></i> &nbsp Tel 1: <a href="tel:+256200900654">+256200900654</a></p>
                <p><i class='bx bx-phone' style='color:#0a5b7c' ></i> &nbsp Tel 2: <a href="tel:+256782644408">+256782644408</a></p>
                <p><i class='bx bx-phone' style='color:#0a5b7c' ></i> &nbsp Tel 3: <a href="tel:+256753105518">+256753105518</a></p>
                <p><i class='bx bx-mail-send' style='color:#0a5b7c'  ></i> &nbsp Email: <a href="mailto:info@tukuuma.org">info@tukuuma.org</a></p>
            </div>
        </div>
    </div>
</section>
