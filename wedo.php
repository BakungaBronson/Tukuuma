<?php include_once 'assets/includes/header.php'; ?>
    <section class="us variation-light display" id="us">
        <div class="row d-flex align-items-center mt-3" id="remove_margin2">
            <div class="col-sm-6 justify-content-center align-items-center d-flex align-items-start flex-column p-3 set_height1">
                ...
                <div class="row p-2 w-100 h-25 d-flex align-items-center justify-content-center back_blue" id="remove_margin2">
                    <h1>Our Approach</h1>
                </div>
            </div>
        </div>
    ...
    <section class="variation">
        ...
        <div class="row d-flex align-items-center mt-3 mb-3" id="remove_margin2">
            <div class="col-sm-5 d-flex justify-content-center flex-column p-3 set_height">
            ...
            <div class="col-sm-2 align-items-center p-3 set_height hide">
                <div class="set_height">
                    <img src="assets/svg/arrow.svg" alt="" srcset="" id="arrow-set">
                </div>
            </div>
            <div class="col-sm-5 d-flex justify-content-center align-items-center p-3 set_height">
    ...
    <section class="partners align-items-center variation-light" id="partners">
        ...
        <div class="row d-flex justify-content-center align-items-center mt-5" id="remove_margin">
            <div class="col-sm p-3 justify-content-center text-center placeholder set_images">
                <img src="assets/svg/miti.svg" alt="miti">
            </div>
            <div class="col-sm  p-3 justify-content-center text-center placeholder set_images">
